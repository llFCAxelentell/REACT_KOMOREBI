...
import { AccountCircleSharp, AssessmentOutlined, ExitToApp, LocalOffer, Person, SearchOutlined, Settings, VideocamOutlined } from "@material-ui/icons";
            ...
            <Divider />
                ...
                <div className={classes.item}>
                    <a href="/manager/users">
                        <div>
                            <Person htmlColor="#FF9900" fontSize="large"/>
                        </div>
                        <div>
                            <Typography variant="h7" fontSize="12px" color="white">
                                Users
                ...
                <div className={classes.item}>
                    <a href="/manager/tags">
                        <div>
                            <LocalOffer htmlColor="#FF9900" fontSize="large"/>
                        </div>
                        <div>
                            <Typography variant="h7" fontSize="12px" color="white">
                                Tags
                ...
                <div className={classes.item}>
                    <a href="/manager/statistics">
                        <div>
                            <AssessmentOutlined htmlColor="#FF9900" fontSize="large"/>
                        </div>
                        <div>
                            <Typography variant="h7" fontSize="12px" color="white">
                                Statistics
                ...
                <div className={classes.item}>
                    <a href="/manager/settings">
                        <div>
                            <Settings htmlColor="#FF9900" fontSize="large"/>
                        </div>
                        <div>
                            <Typography variant="h7" fontSize="12px" color="white">
                                Settings
